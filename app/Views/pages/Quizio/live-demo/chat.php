...
<!-- Mirrored from softivuslab.com/html/quizio/live-demo/chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Jul 2025 05:04:39 GMT -->
<head>
    <meta charset="UTF-8" />
    ...
    <title>Chat List - Quizio PWA HTML Template</title>
      ...
      <div class="relative z-10 pb-20">
        <div class="flex justify-between items-center gap-4 px-6">
          <div class="flex justify-start items-center gap-4">
            <h2 class="text-2xl font-semibold text-white">Chat List</h2>
          </div>
        </div>
        <!-- Page Title End -->
        <!-- Search Box Start -->
        ...
        <!-- Search Box End -->
        <div class="pt-24 pl-6">
          <p class="text-xl font-semibold">
            Online <span class="text-p2 dark:text-p1">(12)</span>
          </p>
          <div
            class="flex justify-start items-center gap-3 pt-5 overflow-y-auto vertical-scrollbar pb-2"
          >
            <div class="flex flex-col shrink-0 justify-center items-center">
              <div class="relative border border-p1 p-1 rounded-full">
                ...
                />
                <div
                  class="bg-white p-0.5 rounded-full absolute -right-1.5 bottom-1"
                >
                  <div class="size-3 rounded-full bg-p3"></div>
                </div>
              </div>
              <p class="text-xs pt-2 text-nowrap">Maurice Lynch</p>
            </div>
            <div class="flex flex-col shrink-0 justify-center items-center">
              <div class="relative border border-p1 p-1 rounded-full">
                <img
              ...
              <p class="text-xs pt-2 text-nowrap">Polly Cooper</p>
            </div>
            <div class="flex flex-col shrink-0 justify-center items-center">
              <div class="relative border border-p1 p-1 rounded-full">
                <img
              ...
              <p class="text-xs pt-2 text-nowrap">Minnie Bowman</p>
            </div>
            <div class="flex flex-col shrink-0 justify-center items-center">
              <div class="relative border border-p1 p-1 rounded-full">
                <img
              ...
              <p class="text-xs pt-2 text-nowrap">Craig McKinney</p>
            </div>
            <div class="flex flex-col shrink-0 justify-center items-center">
              <div class="relative border border-p1 p-1 rounded-full">
                <img
              ...
              <p class="text-xs pt-2 text-nowrap">Hattie Bowen</p>
            </div>
            <div class="flex flex-col shrink-0 justify-center items-center">
              <div class="relative border border-p1 p-1 rounded-full">
                <img
              ...
              <p class="text-xs pt-2 text-nowrap">Lou Griffith</p>
            </div>
            <div class="flex flex-col shrink-0 justify-center items-center">
              <div class="relative border border-p1 p-1 rounded-full">
                <img
              ...
              <p class="text-xs pt-2 text-nowrap">Ora Doyle</p>
            </div>
          </div>
        </div>

        <p class="font-semibold pt-5 px-6">Most recent</p>

        <div class="px-6 flex flex-col gap-5 pt-5">
          <a href="chat-box.html" class="flex justify-between items-center">
            <div class="flex justify-start items-center gap-3">
              ...
              <div class="">
                <p class="font-semibold">Mittie Sharp</p>
                <p class="text-color5 text-xs dark:text-white">
                  You are now connect on quizio chat....
                  <span class="font-semibold">20 Oct</span>
                </p>
              </div>
            </div>
          </a>
          <a href="chat-box.html" class="flex justify-between items-center">
            <div class="flex justify-start items-center gap-3">
              ...
              <div class="">
                <p class="font-semibold">Bruce Hernandez</p>
                <p class="text-color5 text-xs dark:text-white">
                  You are now connect on quizio chat....
                  <span class="font-semibold">20 Oct</span>
                </p>
          ...
          <a href="chat-box.html" class="flex justify-between items-center">
            <div class="flex justify-start items-center gap-3">
              ...
              <div class="">
                <p class="font-semibold">Nathan Massey</p>
                <p class="text-color5 text-xs dark:text-white">
                  You are now connect on quizio chat....
                  <span class="font-semibold">20 Oct</span>
                </p>
          ...
          <a href="chat-box.html" class="flex justify-between items-center">
            <div class="flex justify-start items-center gap-3">
              ...
              <div class="">
                <p class="font-semibold">Vincent Greene</p>
                <p class="text-color5 text-xs dark:text-white">
                  You are now connect on quizio chat....
                  <span class="font-semibold">20 Oct</span>
                </p>
          ...
          <a href="chat-box.html" class="flex justify-between items-center">
            <div class="flex justify-start items-center gap-3">
              ...
              <div class="">
                <p class="font-semibold">Hannah Bowman</p>
                <p class="text-color5 text-xs dark:text-white">
                  You are now connect on quizio chat....
                  <span class="font-semibold">20 Oct</span>
                </p>
          ...
          <a href="chat-box.html" class="flex justify-between items-center">
            <div class="flex justify-start items-center gap-3">
              ...
              <div class="">
                <p class="font-semibold">Henrietta Robbins</p>
                <p class="text-color5 text-xs dark:text-white">
                  You are now connect on quizio chat....
                  <span class="font-semibold">20 Oct</span>
                </p>
          ...
          <a href="chat-box.html" class="flex justify-between items-center">
            <div class="flex justify-start items-center gap-3">
              ...
              <div class="">
                <p class="font-semibold">Darrell Craig</p>
                <p class="text-color5 text-xs dark:text-white">
                  You are now connect on quizio chat....
                  <span class="font-semibold">20 Oct</span>
                </p>
    ...
    <div class="fixed bottom-0 left-0 right-0 z-40">
      ...
      >
        ...
        >
          ...
          >
            <i class="ph ph-users-three text-xl !leading-none text-white"></i>
          </div>
