...
<head>
    ...
    <title>Search Result - Quizio PWA HTML Template</title>
    ...
    >
      ...
      <div class="searchContestResultTab pt-5 relative z-10">
        <ul class="flex justify-start items-center gap-3 tab-button">
          ...
          <li id="tabTwo" class="tabButton cursor-pointer">People</li>
          <li id="tabThree" class="tabButton cursor-pointer">Collection</li>
        </ul>
